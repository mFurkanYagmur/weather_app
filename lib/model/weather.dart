...
class Weather {
  ...
  factory Weather.fromJson(Map<String, dynamic> json) => Weather(
    ...
    time: json["time"] == null ? null : DateTime.parse(json["time"]) , //json["time"] == null ? null : DateTime.parse(json["time"]),
  ...
  @override
  String toString() {
    return 'Weather{sunSet: $sunSet, parent: $parent, title: $title, woeid: $woeid, timezone: $timezone}';
  }
}
